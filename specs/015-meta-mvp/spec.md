...
| FR-008 | DAG editor UI: list pipelines under a root; draw and connect blocks; add, remove and reorder steps; edit `role`, `kind`, `prompt` and prompt bodies inline; create a new pipeline from a template without touching disk until it validates. A rejected save shows the validator's message verbatim.                                                                                                                                                                                                                                                                                                                                                                                                     | TODO   |
