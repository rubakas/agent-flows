...
code-review    local      refused: correctness: step "correctness" under profile "local" resolves to model entry "ollama-qwen" (transport api), which cannot enforce permissions.contents "read"
